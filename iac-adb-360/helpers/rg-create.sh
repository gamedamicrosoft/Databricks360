...
subscriptionid='1bf6f6d4-b209-4338-abc0-702ab91dd764'
...
serviceprincipaloid=$(az ad sp list --display-name $serviceprincipalname --query "[].appId" -o tsv)
echo "found $serviceprincipaloid for devops-sc"

adbspoid=$(az ad sp list --display-name $adbinteractprincipalname --query "[].appId" -o tsv)
